...
const Announcement: React.FC = () => {
    ...
    return (
        <div
            dir="rtl"
            className="relative isolate z-50 flex w-full items-center gap-x-6 overflow-hidden border-b border-blue-950 bg-[#426135] px-6 py-2.5 sm:px-3.5 sm:before:flex-1"
        >
