...
const Button: React.FC<ButtonProps> = ({ children, variant = 'default', size = 'default', shape, className, ...props }) => {
  ...
  const variantClasses = {
    ...
    secondary: 'border border-green-700 bg-green-700 font-bold text-white shadow-2xl shadow-green-500/50 hover:bg-[#1d9248] active:bg-green-950 active:text-green-500',
