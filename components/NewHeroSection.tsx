...
const NewHeroSection: React.FC = () => {
    return (
        <div dir="rtl" className="flex w-full flex-col mx-auto max-w-[900px] items-center justify-between sm:pb-8 sm:pt-8">
            <div className="relative z-0 flex h-auto w-full flex-col items-center justify-center">
                <div className="relative isolate">
                    <div
                        className='container relative mx-auto w-full max-w-7xl rounded-3xl px-4 sm:my-8 sm:px-6 md:px-8'
                    >
                        <div>
                            <div>
